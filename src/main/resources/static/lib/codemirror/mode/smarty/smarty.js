  ...
  var parsers = {
    ...
    smarty: function(stream, state) {
      if (stream.match(settings.rightDelimiter, true)) {
        ...
        return helpers.cont("templates.admin.manage.tag.tag", null);
      }

      if (stream.match(settings.leftDelimiter, true)) {
        state.depth++;
        return helpers.cont("templates.admin.manage.tag.tag", "startTag");
      }
      ...
      if (ch == "$") {
        ...
        return helpers.cont("templates.admin.manage.tag.tag", "templates.admin.manage.tag.tag");
      }
    },
